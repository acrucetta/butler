...
| Operator control surface (CLI/TUI) | 3 | `butler tui` now provides a minimal command bar for remote submit/status/approve/abort flows | Add automated TUI interaction smoke tests |
